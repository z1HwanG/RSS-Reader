...
**Project status**: `0.3.4`, early development; features and the persisted format (`schema_version`
...
| File | Notes |
|------|-------|
| `RSSReader_0.3.4_x64-setup.exe` | NSIS installer (recommended) |
| `RSSReader_0.3.4_x64_en-US.msi` | MSI package |
| `RSSReader_0.3.4_x64_portable.exe` | Portable single file; WebView2 must already be installed |
