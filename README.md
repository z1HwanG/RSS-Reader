...
**Project status**: `0.7.0`, early development; features and the persisted format (`schema_version`
...
| File | Notes |
|------|-------|
| `RSSReader_0.7.0_x64-setup.exe` | NSIS installer (recommended) |
| `RSSReader_0.7.0_x64_en-US.msi` | MSI package |
| `RSSReader_0.7.0_x64_portable.exe` | Portable single file; WebView2 must already be installed |
